...
class ResNet(torch.nn.Module):
    def __init__(self):
        ...
        self.module_3 = py_nndct.nn.ReLU(inplace=True) #ResNet::ResNet/ReLU[relu]/139
        ...
        self.module_67 = py_nndct.nn.AdaptiveAvgPool2d(output_size=1) #ResNet::ResNet/AdaptiveAvgPool2d[avgpool]/483
        self.module_68 = py_nndct.nn.Module('flatten') #ResNet::ResNet/input
        self.module_69 = py_nndct.nn.Linear(in_features=512, out_features=2, bias=True) #ResNet::ResNet/Linear[fc]/490
    ...
    def forward(self, *args):
        ...
        self.output_module_10 = self.module_10(other=self.output_module_4, input=self.output_module_8, alpha=1)
        ...
        self.output_module_17 = self.module_17(other=self.output_module_11, input=self.output_module_15, alpha=1)
        ...
        self.output_module_26 = self.module_26(other=self.output_module_24, input=self.output_module_22, alpha=1)
        ...
        self.output_module_33 = self.module_33(other=self.output_module_27, input=self.output_module_31, alpha=1)
        ...
        self.output_module_42 = self.module_42(other=self.output_module_40, input=self.output_module_38, alpha=1)
        ...
        self.output_module_49 = self.module_49(other=self.output_module_43, input=self.output_module_47, alpha=1)
        ...
        self.output_module_58 = self.module_58(other=self.output_module_56, input=self.output_module_54, alpha=1)
        ...
        self.output_module_65 = self.module_65(other=self.output_module_59, input=self.output_module_63, alpha=1)
        self.output_module_66 = self.module_66(self.output_module_65)
        self.output_module_67 = self.module_67(self.output_module_66)
        self.output_module_68 = self.module_68(input=self.output_module_67, end_dim=3, start_dim=1)
